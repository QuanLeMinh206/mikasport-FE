    ...
    return (
        <section className="mb-[120px] mt-[35px]">
            <div className="content">
                <h4 className="text-[22px] font-semibold text-secondary">Our Products</h4>
                <div className="flex items-center justify-between">
                    {" "}
                    <h2 className="text-[42px] font-semibold text-secondary">Our Top Seller Products</h2>
                    <div className="flex gap-[20px]">
                        <button className="btn h-[45px] w-[84px]">All</button>
                        <button className="btn h-[45px] w-[115px] border-primary bg-white text-primary">Woman</button>
                        <button className="btn h-[45px] w-[72px] border-primary bg-white text-primary">Men</button>
                    </div>
                </div>
            </div>
