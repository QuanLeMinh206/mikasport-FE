...
export const EditCategory = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.put(`http://localhost:8000/api/admin/categories/${id}`, {
                name: categoryName,
            });
            console.log("Category updated:", response.data);
            alert("Category updated successfully!");
            navigate("/admin/categories"); // Điều hướng về trang danh sách categories sau khi cập nhật thành công
        } catch (error) {
