            ...
            <div className="flex items-center justify-center bg-gray-100">
                <div className="flex w-[1440px] justify-between rounded-[12px] bg-white">
                    ...
                    <div className="ml-[75px] flex flex-col justify-center border">
                        ...
                        >
                            {" "}
                            <h2 className="text-center text-[34px] font-semibold text-gray-800">Register</h2>
                            <p className="text-medium mt-[24px] text-center text-[18px] text-gray-500">Welcome back! Please enter your details.</p>
                            <div className="my-[26px]">
                                <label className="mb-[14px] block font-medium text-secondary">Name</label>
                                <input
                                    type="text"
                                    name="name"
                                    value={formData.name}
                        ...
                        <div className="text-center text-gray-500">
                            ...
                            <div className="m mt-[28px] flex items-center justify-center gap-[56px]">
